...
class OTK(QMainWindow):
    def __init__(self):
        ...
        self.build_ui()
        self.recover_flow()  # From v0.3; renamed from prime_pump for consistency
    ...
    # New: Mouse events for frameless window dragging
    ...
    def recover_flow(self):
        ...
        what_if = "What if: Prioritize refactor to unblock 2 RFPs?" if unresolved > 0 else ""
    ...
    def generate_what_if(self, unresolved):
        ...
        branches = [
            "What if: Tackle refactor first? Unblocks 2 RFPs.",
            "What if: Quick util audit? Surfaces 1 hidden leverage.",
            "What if: Scout burst? Chains to 3 creative integrations."
        ]
